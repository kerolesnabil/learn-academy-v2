            ...
            <div class="col-lg-6 col-xl-6">
                <div class="banner_text">
                    <div class="banner_text_iner">
                        ...
                        <h1>{{json_decode($banner->content,true)['subtitle']}}</h1>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        ...
                        <div class="special_cource_text">
                            <a href="{{route('front.show',[$course->cat->id,$course->id])}}" class="btn_4">{{$course->name}}</a>
                            <h4>${{$course->price}}</h4>

                            <a href="{{route('front.cat',$course->cat->id)}}"><h3>{{$course->cat->name}}</h3></a>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-xl-4 col-sm-8 align-self-center">
                                <div class="testimonial_slider_text">
                                    ...
                                    @if($tesimonial->spec!=null)
                                    <h5>{{$tesimonial->spec}}</h5>
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-4 col-xl-2 col-sm-4">
                                <div class="testimonial_slider_img">
                                    <img src="{{asset('uploads/tesimonial/'.$tesimonial->img)}}" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
